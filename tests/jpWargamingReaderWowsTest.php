...
class jpWargamingReaderWowsTest extends TestCase
{
	...
	public function test_requestTypes()
	{
		...
		$this->assertEquals([
				'method' => 'GET',
				'url' => 'http://api.worldofwarships.eu/wows/account/list/?search=Metwurst&type=exact&limit=100&language=en&application_id=03e3653b14d26e8136d5870a1512e3c4',
				'query' => [
					'search' => 'Metwurst',
					'type' => 'exact',
					'limit' => 100,
		...
		$this->assertEquals([
				'method' => 'POST',
				'url' => 'http://api.worldofwarships.eu/wows/account/list/',
				'query' => [
					'search' => 'Metwurst',
					'type' => 'exact',
					'limit' => 100,
	...
	public function test_getAccountInfo()
	{
		...
		$expected = '{"status":"ok","meta":{"count":1,"hidden":null},"data":{"500554376":{"nickname":"Metwurst"}}}';
		...
		$expected = '{"status":"ok","meta":{"count":1,"hidden":null},"data":{"500554376":{"nickname":"Metwurst","account_id":500554376}}}';
